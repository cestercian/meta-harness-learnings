...
- Reasoning models may wrap a whole ReAct turn in `<think>`; recover Action/Final Answer from inner think text only when it looks like ReAct, and skip replaying empty scratchpad entries (#1611 / open fix #2227).
