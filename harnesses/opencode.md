...
- Second wave (2026-09-21): rewrite `0.0.0.0`/`::` service URLs to loopback for clients (#49805); invoked-bin resume hint (#49807); alias pre-2.0.9 theme tokens (#49937); default omitted `capabilities.tools` for custom providers (#49940); trailing-slash OAuth issuer equivalence (#50046); foreground `serve` listening marker for VS Code (#50047); ErrorBoundary around plugin Slot (#50048); Windows prefer `.cmd` over nvm `.ps1` for npm/npx (#50050).
